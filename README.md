...
This project demonstrates the design and implementation of security controls in an AWS environment. It focuses on identity protection, least-privilege access, cloud activity monitoring, secure data storage, security-event investigation and incident-response preparation.
...
| Risk of accidental object overwrite    | Versioning enabled and successfully tested |
...
The AWS Budgets, IAM, CloudTrail and secure S3 phases are complete. The next phase focuses on IAM Access Analyzer and external-access findings.
